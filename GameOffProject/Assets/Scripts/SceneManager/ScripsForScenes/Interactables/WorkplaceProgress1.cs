...
public class WorkplaceProgress1 : MonoBehaviour
{
    [Header("Visual Cue")]
    ...
    private OutsideOfficeManager outsideOfficeManager;
    private void Awake()
    {
        playerInRange = false;
    ...
    void Start()
    {
        ...
        outsideOfficeManager = FindObjectOfType<OutsideOfficeManager>();
    ...
    private void UpdateDialogue()
    {
        ...
        else if (playerInRange && !dialogueManager.dialogueIsPlaying)
        {
            ...
            {
                outsideOfficeManager.hasTriggered1 = true;
                playerObject.EnterDialogueMode();
